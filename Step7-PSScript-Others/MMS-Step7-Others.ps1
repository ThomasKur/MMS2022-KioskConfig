<#
.Synopsis
This script is used to set other recommended settings for Kiosk scenarios like 
 - Disable Bluescreen information on screen
...
$ScriptVersion = "001"
$ScriptName = "MMS-Step7-Others.ps1"
...
Set-RegValue -Path "HKLM:\SYSTEM\CurrentControlSet\Control\CrashControl" -Name DisplayDisabled -Value 1 -Type DWord
